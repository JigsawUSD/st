export const testimonials = [
  ...
  },
  {
    name: 'Mariana C.',
    role: 'Mãe da Sofia',
    quote: 'Eu estava completamente perdida com a introdução alimentar. O Baby Bites Hub me deu confiança e muitas ideias deliciosas. Recomendo de olhos fechados!',
  },
  {
    name: 'Fernanda P.',
    role: 'Mãe do Arthur',
